                ...
                <Box paddingX={1} paddingY={1} className='mt'>
                    <form onSubmit={onSubmit}>
                        ...
                        <Grid className='container'>
                            <TextField className='ml mr' value={user.genero_usuario} onChange={(e: ChangeEvent<HTMLInputElement>) => updatedModel(e)} id='genero' label='Gênero' variant='outlined' name='genero_usuario' margin='normal' fullWidth />
                            <TextField value={user.estado_civil} onChange={(e: ChangeEvent<HTMLInputElement>) => updatedModel(e)} id='estadoCivil' label='Estado Civil' variant='outlined' name='estado_civil' margin='normal' fullWidth  />
